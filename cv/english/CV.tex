...
\quote{Objective: a 6-month internship in software development commencing Autumn 2015}
...
\cventry{September 2014 -- present}{IT Project Manager}{USEC}{Compiègne}{}{I’m in charge of software development projects. I help our clients throughout the process, ensuring total satisfaction from specifying their needs to testing and implementation. The tech part of each project is made by students.
\begin{itemize}
  \item Writing official documents (quotes, specifications, customer agreements, etc.)
  \item Management of students
\end{itemize}}
...
\item I changed the languages used on the server: from PHP to Scala and from MySQL to PostgreSQL
\item I wrote internal documentation and set up a versioning system (Git)
\end{itemize}}

\cventry{October 2013 -- March 2014}{College project}{Nantes University Institute of Technology (IUT de Nantes)}{Nantes}{}{Development of a streaming server on a Raspberry-Pi (group project). I carried out the server development (Tomcat/Java EE) and the Android application development (Java)}

\section{Education}
\cventry{2014 -- present}{First year engineering student (Première année du cycle ingénieur)}{Université Technologique de Compiègne}{Compiègne}{}{Majoring in Computer Science} % year, degree, institution, city+picture = {\includegraphics[scale=0.5]{picture}City}, grade, description
\cventry{2012 -- 2014}{Two-year core studies diploma in computer science (DUT Informatique)}{Nantes University Institute of Technology (IUT de Nantes)}{Nantes}{}{}
...
\cvitem{Other}{Knowledge in communication and business management (from DUT Informatique)}

\section{Hobbies}
\cvdoubleitem{Music}{I've been playing the guitar for nine years}{Sport}{Workout, badminton}
\cvdoubleitem{Free software}{I'm a fervent defender}{Computer science meetings}{DevFest (France), Web2Day (France)}
\end{document}
