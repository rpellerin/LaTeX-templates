...
\quote{Recherche un stage (6 mois) en développement logiciel à partir de Septembre 2015}
...
\cventry{Septembre 2014\\à Présent}{Chargé d'affaires, puis Responsable du pôle informatique}{USEC}{Compiègne}{}{Poste semblable à celui de chef de projet, j'accompagne nos clients de la spécification de leur besoin à la livraison, pour leur apporter totale satisfaction. En tant que responsable depuis Janvier 2015, je manage les chargés d'affaires en informatique.
\begin{itemize}
  \item Rédaction de documents (devis, cahier des charges, convention client, etc)
  \item Management d'étudiants pour la réalisation des études
\end{itemize}}
...
\begin{itemize}%
\item Migration du \textit{back-end} vers une solution de type \og\textit{cloud}\fg{} (\href{http://www.clever-cloud.com/}{Clever Cloud})
...
\cvitem{Langages}{C, C++, Java (SE et EE), PHP, HTML, CSS, Javascript, Bash, x86 assembly}
\cvitem{Analyse}{UML, Design Patterns}
\cvitem{Bases de données}{Oracle, MySQL, PostgreSQL, Microsoft SQL Server (notions)}
\cvitem{Systèmes}{GNU/Linux (Debian), Windows XP/7/8}
\cvitem{Autres}{Apache2, iptables, fail2ban, OpenVPN, Git, Subversion, TCP/IP}
%\cvitem{Logiciels}{LaTeX, Microsoft Office, LibreOffice, Adobe Photoshop}

\section{Compétences générales}
\cvitem{Anglais}{\textbf{Niveau professionnel} (niveau européen B2) -- \textbf{Toeic 895/990}} % \cvlanguage{Anglais}{}{}
...
\cvdoubleitem{\textbf{Informatique}}{Logiciel libre, \href{https://github.com/rpellerin}{GitHub}}{\textbf{Conférences}}{DevFest, Web2Day}
\cvdoubleitem{\textbf{Raspberry Pi}}{Auto-hébergement, VPN, ownCloud}{}{}
\end{document}
