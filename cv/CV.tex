...
\usepackage[top=0.2cm, bottom=0.2cm, left=0.7cm, right=0.7cm]{geometry}
...
\address{Currently living in Paris}{\textbf{Open to relocation}}{} % street, city, country
...
\cventry{Feb 2017 -- Feb 2018}{Software Engineer}{\href{http://matters.tech/}{Matters}}{San Francisco (USA) and Paris (France)}{}{
\begin{itemize}
    \item As a full time employee from Sep 2017, worked for \href{https://wisepops.com}{Wisepops.com} on their new popup editor.\\Stack: JavaScript (ES6+), CSS (displaying popups is quite challenging), React, Redux and NodeJS.
    \item As an intern from Feb 2017 to Jul 2017, worked on a brand new project: \href{http://teamstarter.co/}{Teamstarter}. Also experimented new technologies: asm.js and WebAssembly. My missions involved React, Redux, \href{http://sequelizejs.com/}{Sequelize}, \href{http://graphql.org/}{GraphQL}, \href{http://www.apollodata.com/}{Apollo}, PWA (Service Workers), CDNs.
\end{itemize}
}
