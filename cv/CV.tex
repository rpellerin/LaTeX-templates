...
\cventry{September 2015 -- February 2016}{Intern in mobile application development}{\href{http://www.wearesmiths.com/}{The Smiths}}{Amsterdam (The Netherlands)}{}{Developed Android and iOS applications with the \href{http://www.appcelerator.com/}{Appcelerator} framework (Titanium).
\begin{itemize}
  \item Front-end with the following frameworks: Backbone, Underscore, Titanium/Alloy, React
  \item Back-end with Express, hosted on \href{http://www.parse.com/}{parse.com}
\end{itemize}}
...
\cvitem{OSs}{\textbf{GNU/Linux} (\href{http://xubuntu.org/}{Xubuntu} as my main OS, based on Debian)}
