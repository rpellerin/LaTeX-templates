...
\vspace{-15pt}
\section{Experience}
\cventry{Sep 2022 -- Present}{Engineering Manager}{\href{https://www.doctolib.de/}{Doctolib GmbH}}{Berlin (Germany)}{}{Currently managing a team of 7 developers + 1 QA analyst focused on Doctolib's main product line that is generating 80\% of the revenue (booking management system).\\Had up to 12 direct reports, 2 different teams.\\\\
...
\cventry{Mar 2015 -- Jun 2015}{Co-host of tech talks and speaker myself}{\href{https://www.youtube.com/playlist?list=PL3nMxbEwNq0wE3BNx5b0EEtp8h-yvHyIy}{HumanTalks}}{Compiègne (France)}{}{10-min talks given once a month about programming languages, tools, software development, etc.\\\href{https://humantalks.com/cities/compiegne}{https://humantalks.com/cities/compiegne}}
...
\cvdoubleitem{\textbf{DIY:}}{Tinkering with Arduinos, Raspberry Pis, Python scripts and sensors... also making furniture, \href{https://romainpellerin.eu/motorizing-an-ikea-skarsta-standing-desk.html}{hacking IKEA desks}}{\textbf{Reading:}}{Big fan of comic books (The Walking Dead, Paper Girls, Saga, Low). Recent reads: Hyperion (sci-fi), The Culture Map (business)}
\cvdoubleitem{\textbf{Sport:}}{Road cycling (6,100 kms in 2023), running (1,400 kms in 2024 - marathon PR: 3h12), swimming and weight lifting}{\textbf{Music:}}{Guitar for fifteen years}
\end{document}
