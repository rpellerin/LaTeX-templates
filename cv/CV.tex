...
\cventry{September 2015 -- February 2016}{Intern in mobile application development}{\href{http://www.wearesmiths.com/}{The Smiths}}{Amsterdam (The Netherlands)}{}{I will develop Android and iOS applications with the \href{http://www.appcelerator.com/}{Appcelerator} framework.}
...
\cvitem{Languages}{\textbf{C++ (Qt), Java (SE \& EE), PHP, HTML, CSS}, JavaScript, Python, C, Bash, x86 assembly}
\cvitem{Modeling}{\textbf{UML}}
\cvitem{Databases}{\textbf{MySQL, PostgreSQL}, SQLite}
...
\cvdoubleitem{Conferences}{\href{http://devfest.gdgnantes.com/}{DevFest}, \href{http://web2day.co/}{Web2Day}}{Free software}{Fervent defender, I often push my source code on \href{https://github.com/rpellerin}{GitHub}}
