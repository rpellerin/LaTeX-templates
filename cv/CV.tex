...
\cventry{Sep 2017 -- present}{Software Engineer}{\href{http://matters.tech/}{Matters}}{Paris (France)}{}{
\begin{itemize}
    \item Web development mostly: JavaScript (ES8), React, Redux, NodeJS, GraphQL, PWA, CDN, SQL, ...
\end{itemize}
}
\cventry{Feb 2017 -- Jul 2017}{Intern in software development}{\href{http://matters.tech}{Matters}}{San Fransisco (USA)}{}{
\begin{itemize}
