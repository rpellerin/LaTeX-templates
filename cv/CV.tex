...
\vspace{-15pt}
\section{Experience}
\cventry{Sep 2022 -- Present}{Engineering Manager}{\href{https://www.doctolib.de/}{Doctolib GmbH}}{Berlin (Germany)}{}{Managing a team of 6 developers focused on performance and loading time optimization.\\Since April 2023, also managing a second team of 6 developers focused on improving the return on investement for healthcare professionals. 12 direct reports in total.}
...
\begin{itemize}
    ...
    \item 2019-2021: \href{https://romainpellerin.eu/waving-goodbye-to-internet-explorer-11-in-2021.html}{decided the end of the support of Internet Explorer 11 and led a company-wide program to help Doctolib's customers upgrade their outdated browsers}, from small practices to large hospitals, allowing 1. the removal of tests on these browsers 2. simplifying our front-end build pipeline 3. decreasing the number of incidents related to old browsers close to zero
...
\end{itemize}~\\
\textbf{Stack:} Ruby on Rails, PostgreSQL, Resque, Redis, ElasticSearch, React, SASS/SCSS, Docker.\\Our CI executes 40,000+ integration tests (Minitest + Capybara) and a few hundred model and unit tests (JavaScript and Ruby).\\\\
Additional relevant keywords: AWS, New Relic, Sentry, SCRUM/agile development.
}
...
\textbf{Stack:} \href{https://www.appcelerator.com/Titanium/}{Titanium/Alloy (JavaScript framework)}, Backbone.js, Underscore.js, Express.js.
}
\vspace{25pt}
\cventry{Jun 2013 -- Sep 2014}{Android and Web Developer}{Self-employed and then intern}{Nantes (France)}{}{Developed and maintained the Android application and the website of the startup \textsc{\href{http://www.who-wanna.com/en/}{WhoWanna}}.\\
...
\cvlanguage{English}{Proficient -- European (CEFR) C2 level}{\textbf{TOEIC 985/990 (March 2016)}}
\cvlanguage{German}{Intermediate -- European (CEFR) B1 level}{}
\cvlanguage{Spanish}{Beginner -- European (CEFR) A1 level (estimated)}{}

\vspace{10pt}
\section{Hobbies}
\cvdoubleitem{\textbf{Raspberry Pi:}}{Tinkering with cameras, OpenVPN, Nextcloud, sensors...}{\textbf{Comic books:}}{The Walking Dead, Paper Girls, Saga, Low, and many others}
\cvdoubleitem{\textbf{Sport:}}{Road cycling (5,900 kms in 2022), running and weight lifting}{\textbf{Music:}}{Guitar for fifteen years}
\end{document}
