...
\firstname{Romain}
\familyname{Pellerin}
\title{Principal Software Engineer at Doctolib GmbH}
...
\vspace{-15pt}
\section{Experience}
\cventry{Oct 2020 -- Present}{Principal Software Engineer}{\href{https://www.doctolib.de/}{Doctolib GmbH}}{Berlin (Germany)}{}{
\begin{itemize}
    ...
    \item Interviewing engineering directors, managers and software engineers
\end{itemize}~\\
...
\begin{itemize}
    ...
    \item 2019-2021: decided the end of the support of Internet Explorer 11 and led a company-wide program to help Doctolib's customers upgrade their outdated browsers, from small practices to large hospitals, allowing 1. the removal of tests on these browsers 2. simplifying our front-end build pipeline 3. decreasing the number of incidents related to old browsers close to zero
    \item 2018-2021: led a cross-team effort to refactor 600+ files written in RxJS to vanilla JavaScript or React hooks, hence removing the number one pain point that was reported by developers about the front-end stack at that time
...
\end{itemize}~\\
Stack: Ruby on Rails, PostgreSQL, Resque, Redis, ElasticSearch, React. Our CI executes 30,000+ integration tests (Minitest + Capybara) and a few hundred model and unit tests (JavaScript and Ruby).\\\\
Additional relevant keywords: AWS, TeamCity, New Relic, Sentry, Jest, SCSS.
}
\vspace{10pt}
\cventry{Jan 2020 -- Oct 2020}{Software Engineer}{\href{https://www.doctolib.de/}{Doctolib GmbH}}{Berlin (Germany)}{}{
\begin{itemize}
    \item Worked on the website for healthcare professionals as a fullstack developer
...
Stack: \href{https://www.appcelerator.com/Titanium/}{Titanium/Alloy (JavaScript framework)}, Backbone.js, Underscore.js, Express.js.
}
\vspace{10pt}
...
\cvlanguage{Spanish}{Beginner -- European A1 level}{}
